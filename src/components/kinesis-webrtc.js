...
const state = store({
  ...
  accessKey: "CONTACT ADMIN FOR KEYS",
  secretAccessKey: "CONTACT ADMIN FOR KEYS",
  sessionToken: "",
  region: "ap-southeast-2",
  role: OPTIONS.ROLE.MASTER,
  channelName: "signal_channel_v1",
  ...
  return (
    <Widget>
      ...
      <TextField
        ...
        onChange={(e) => {
          updateState("sessionToken", e.target.value);
        }}
      ...
      <FormControl className={classes.formControl}>
        ...
        >
          ...
          <MenuItem value={OPTIONS.TRAVERSAL.TURN_ONLY}>
      ...
      <FormControlLabel
        control={
          <Checkbox
            color="primary"
            checked={state.useTrickleICE}
            onChange={(e) => updateState("useTrickleICE", e.target.checked)}
          />
        }
        label="Trickle ICE"
        labelPlacement="top"
      ...
      <FormControl className={classes.formControl}>
        ...
        >
          <MenuItem value={OPTIONS.RESOLUTION.WIDESCREEN}>
            1280x720 (16:9 widescreen)
          </MenuItem>
          <MenuItem value={OPTIONS.RESOLUTION.FULLSCREEN}>
      ...
      <FormControlLabel
        control={
          <Checkbox
            color="primary"
            checked={state.sendVideo}
            onChange={(e) => updateState("sendVideo", e.target.checked)}
          />
        }
        label="Send video"
        labelPlacement="top"
      ...
      <FormControlLabel
        control={
          <Checkbox
            color="primary"
            checked={state.sendAudio}
            onChange={(e) => updateState("sendAudio", e.target.checked)}
          />
        }
        label="Send audio"
        labelPlacement="top"
      ...
      <FormControlLabel
        control={
          <Checkbox
            color="primary"
            checked={state.openDataChannel}
            onChange={(e) => updateState("openDataChannel", e.target.checked)}
          />
        }
        label="Data channel"
        labelPlacement="top"
  ...
  if (state.role === OPTIONS.ROLE.MASTER) {
    Object.keys(state.dataChannelByClientId).forEach((clientId) => {
      try {
        ...
        console.log(
          `Message sent to client ${clientId}: ${state.messageToSend}`
        );
      } catch (e) {
